...
### Low-Level Software Developer · Cybersecurity · Embedded Systems
...
```
LANGUAGES      |  C · C++ · C# · Python · JavaScript · Node.js · T-SQL
SYSTEMS        |  Linux Kernel Modules · POSIX · Socket Programming · System Programming
NETWORKING     |  TCP/IP · Netlink Sockets · Raw Sockets · DPI · Network Protocols
WEB            |  React.js · Express.js · REST APIs · Full-Stack
DATABASES      |  MySQL · MongoDB
DEVOPS         |  Docker · Linux · Git · Makefile · Static Code Analysis
```
...
### 🔍 [lexer](https://github.com/idosulam/lexer) — Advanced C Code Search Engine

> Full-stack platform for static analysis and search of C source code.
> Custom **lexer/parser** in Python · REST APIs · MySQL schema for indexed code structure retrieval

`Python` `ReactJS` `Node.js` `MySQL` `Static Code Analysis`
...
[![Portfolio](https://img.shields.io/badge/Portfolio-idosulam.vercel.app-black?style=for-the-badge&logo=vercel)]([https://idosulam.vercel.app](https://portfolio-avg.pages.dev/))
